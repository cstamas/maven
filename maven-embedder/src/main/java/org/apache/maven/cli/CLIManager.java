...
public class CLIManager
{
    ...
    public static final String IGNORE_POM_REPOSITORIES = "ipr";
    ...
    public CLIManager()
    {
        ...
        options.addOption( Option.builder( IGNORE_POM_REPOSITORIES ).longOpt( "ignore-pom-repositories" ).desc( "Ignore dependency POM repository declarations" ).build() );
