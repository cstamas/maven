...
/**
 * Maven Plugin Artifact Handler.
 *
 * @since 3.10.0
 */
@Singleton
@Named(MavenPluginArtifactHandler.NAME)
public final class MavenPluginArtifactHandler implements Provider<ArtifactHandler> {
    public static final String NAME = "maven-plugin";

    private final ArtifactHandler instance;

    public MavenPluginArtifactHandler() {
        this.instance =
